    ...
    <div>
       <header className="showcase">
			<div className="showcase-top">
				...
				<Link to={"/login"}><a  className="btn btn-rounded">Sign In</a></Link>
        ...
        <h2></h2>
				...
				<a href="/" className="btn btn-xl">Watch Free For 30 Days <i className="fas fa-chevron-right btn-icon"></i></a>
			</div>
		</header>
